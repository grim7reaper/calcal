...
module CalCal
  ...
  class JulianDay
    ...
    # Equation (1.3) of Calendrical Calculations, 3rd edition.
    EPOCH = -1721424.5

    # Equation (1.11) of Calendrical Calculations, 3rd edition.
    ...
    # Equation (1.10) of Calendrical Calculations, 3rd edition.
